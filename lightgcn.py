...
parser = argparse.ArgumentParser(description="Run baseline LightGCN model.")
...
print(f"Running LightGCN model on dataset: {selected_dataset} with GPU: {args.gpu_id}")
run_recbole(model='LightGCN', dataset=selected_dataset, config_dict=parameter_dict)